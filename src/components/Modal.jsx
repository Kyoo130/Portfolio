        ...
        <ListCont>
          ...
          <li>
            ...
            <Contents>
              ...
              <br /><br />
              이를 해결하기 위한 방법으로 내부 시스템 고도화를 추진하였고, 서비스를 기획하려면 개발에 대한 이해가 요구되었습니다.{"\n"}
              퇴근 후 별도로 공부를 하며 서비스를 기획하였고, 그 결과 서비스가 개발되어 비효율적인 프로세스를 개선할 수 있었습니다.
              <br /><br />
              위 경험을 계기로 사용자 편의를 반영한 서비스를 직접 만들어 내고 싶다는 포부를 가지게 되었고,{"\n"}
              많은 고민 끝에 다니던 직장을 퇴사하고 프론트엔드 개발자가 되기 위해 도전을 시작하게 되었습니다.
            </Contents>
          </li>
          <li>
